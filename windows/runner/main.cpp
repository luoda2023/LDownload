...
static LONG WINAPI LDownloadCrashHandler(EXCEPTION_POINTERS* ep) {
...
static const wchar_t kMutexName[] = L"Global\\LDownload_SingleInstance_Mutex";
...
static const wchar_t kWindowTitle[] = L"LDownload";
...
// Try to find the existing LDownload window, send it our command-line args
...
int APIENTRY wWinMain(_In_ HINSTANCE instance, _In_opt_ HINSTANCE prev,
  ...
  ::SetUnhandledExceptionFilter(LDownloadCrashHandler);
