...
/* ============================================================
   ...
   - Detail panel: 1:1 match with real LDownload app
   ============================================================ */
...
export default function HeroSection() {
  ...
  const selectPlatform = useCallback((key: string) => {
    ...
    window.dispatchEvent(
      new CustomEvent("ldownload:select-platform", { detail: key }),
    );
    document
...
/* ================================================================
   DetailPanel — 1:1 match with real LDownload detail_panel.dart
   ================================================================ */
