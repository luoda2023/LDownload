...
// ── 数据类型（对应 ldownload-themes 仓库 index.json）──

const THEMES_REPO = "luoda2023/ldownload-themes";
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        {error && !loading && (
          <div className="text-center py-20">
            ...
            <a
              href="https://github.com/luoda2023/ldownload-themes"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-3 inline-block text-xs text-brand-sky hover:underline"
            >
              github.com/luoda2023/ldownload-themes →
            </a>
          </div>
        )}
