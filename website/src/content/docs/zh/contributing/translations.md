...
LDownload 的多语言在公开的 [luoda2023/LDownload](https://github.com/luoda2023/LDownload) 仓库中维护。社区用户通过 GitHub Pull Request 贡献语言更新。
...
| **Website** | dicad.cn 官网——首页、FAQ、更新日志 |

英文是源语言，简体中文由核心团队维护，其余语言等你来开创。

## 快速开始

1. Fork [luoda2023/LDownload](https://github.com/luoda2023/LDownload)，从 `main` 创建分支。
2. 新增或更新对应部件的翻译文件：
