---
title: Translating LDownload
description: Help translate the app, the web UI, and this website by contributing on GitHub.
section: contributing
order: 2
---

LDownload translations are maintained in the public [luoda2023/LDownload](https://github.com/luoda2023/LDownload) repository. Community members contribute language updates through GitHub pull requests.
...
| **Website** | dicad.cn — landing page, FAQ, changelog |

English is the source language; Simplified Chinese is maintained by the core team. Everything else is yours to build.

## Quick start

1. Fork [luoda2023/LDownload](https://github.com/luoda2023/LDownload) and create a branch from `main`.
