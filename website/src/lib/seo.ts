...
export const SITE_URL = "https://dicad.cn";
export const SITE_NAME = "LDownload";
...
export const SAME_AS = ["https://github.com/luoda2023/LDownload"];
...
export const HOME_META = {
  en: {
    title: "LDownload — Multi-Protocol Download Manager, Rebuilt in Rust",
    description:
      "LDownload rebuilds the download manager from the ground up: a Rust engine with runtime dynamic segmentation, HTTP/HTTPS/FTP/BitTorrent/ED2K/HLS support, and deep browser integration. Free and open source — no ads, no throttling.",
  },
  zh: {
    title: "LDownload — Rust 重写的多协议下载管理器 | 免费开源下载工具",
    description:
      "LDownload 用 Rust 从头重写下载管理器：运行时动态分段加速，支持 HTTP/HTTPS/FTP/BT 磁力/ED2K/HLS 流媒体，浏览器深度接管。免费开源，无广告，不限速。",
  },
  ja: {
    title: "LDownload — Rust 製マルチプロトコル・ダウンロードマネージャー | 無料・オープンソース",
    description:
      "LDownload は Rust でダウンロードマネージャーをゼロから再構築。実行時の動的セグメント分割、HTTP/HTTPS/FTP/BitTorrent/ED2K/HLS 対応、ブラウザとの深い連携。無料・オープンソース、広告なし、速度制限なし。",
  },
} as const;
...
export function softwareNode(): JsonLdNode {
  return {
    ...
    "@id": SOFTWARE_ID,
    name: SITE_NAME,
    alternateName: "LDownload Download Manager",
