...
<body style="margin:0;padding:0;background:#0a0a0f;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:32px 20px;">
    ...
    <div style="text-align:center;margin-bottom:28px;">
      <h1 style="color:#e4e4e7;font-size:20px;font-weight:700;margin:0;">LDownload</h1>
    ...
    <div style="background:#18181b;border:1px solid #27272a;border-radius:12px;overflow:hidden;">
      ...
      <div style="padding:0 20px 20px;text-align:center;">
        <a href="${feedbackUrl}" style="display:inline-block;padding:10px 24px;background:#3b82f6;color:#fff;text-decoration:none;border-radius:8px;font-size:14px;font-weight:500;">View on LDownload</a>
      </div>
    </div>

    <!-- Footer -->
    <p style="color:#52525b;font-size:11px;text-align:center;margin:20px 0 0;line-height:1.5;">
      You received this email because you submitted feedback on LDownload.<br>
