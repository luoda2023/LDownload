---
description: LDownload 面向用户的文案必须走 i18n 查表，UI 代码里禁止硬编码中文字面量
condition:
...
globs:
  ...
  - 'ldownload/**/*.{ts,tsx,html}'
repeatMode: after-gap
repeatGap: 3
---

你正在 LDownload 的 UI 代码里写死中文文案。**所有面向用户的字段都必须走 i18n 查表**，否则该字段永远只有一种语言，社区也无从翻译。
...
| 扩展（`ldownload/`） | `t('section.key')`，或 HTML 上挂 `data-i18n="section.key"` |
