...
class LDownloadMobileApp extends StatefulWidget {
  ...
  @override
  State<LDownloadMobileApp> createState() => _LDownloadMobileAppState();
}

class _LDownloadMobileAppState extends State<LDownloadMobileApp> {
