...
const _dbFile = 'ldownload.db';
const _dbWal = 'ldownload.db-wal';
const _dbShm = 'ldownload.db-shm';
...
String resolveDataDir() {
  if (Platform.isAndroid) {
    return '/data/data/com.ldownload.app/files/ldownload';
  }
  if (Platform.isLinux) {
    final xdgData = Platform.environment['XDG_DATA_HOME'] ??
        '${Platform.environment['HOME']}/.local/share';
    return '$xdgData/ldownload';
  }
  if (Platform.isMacOS) {
    final home = Platform.environment['HOME'] ?? '';
    return '$home/Library/Application Support/ldownload';
  }
  // Windows
  ...
  return '$localAppData${Platform.pathSeparator}LDownload';
}
