...
/// 与 MainActivity.kt / AppDelegate.swift 的 `com.ldownload/storage` 通道对应。
const _storageChannel = MethodChannel('com.ldownload/storage');
...
///
/// **移动平台（Android/iOS）实现**：
/// 经 `com.ldownload/storage` MethodChannel 走原生实现：
