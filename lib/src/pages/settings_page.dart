...
class _UiScaleSelector extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final tp = LDownloadApp.of(context);
    final c = AppColors.of(context);
    // LDownloadApp.of 走 findAncestorStateOfType，不建立响应式依赖；
...
class _CopyUserscriptButton extends StatelessWidget {
  ...
  Future<void> _copy(BuildContext context) async {
    final s = LocaleScope.of(context);
    try {
      final script = await rootBundle.loadString('userscript/ldownload.user.js');
...
class _ThemeSelector extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final provider = LDownloadApp.of(context);
    ...
    return Row(
      children: [
        ...
        _SmallActionButton(
          ...
          label: s.themeMore,
          colors: c,
          onTap: () => launchUrl(Uri.parse('https://dicad.cn/themes')),
        ),
      ],
    );
  }
