# Contributing to LDownload

感谢你有意为 LDownload 做贡献！/ Thank you for your interest in contributing to LDownload!
...
4. 提交 PR 前确保相关 crate 的测试通过（例如 `cargo test -p ldown_engine`）。
   Make sure the tests for the affected crates pass before opening a PR (e.g. `cargo test -p ldown_engine`).

## 反馈问题 / Reporting Issues

请通过 [GitHub Issues](https://github.com/luoda2023/LDownload/issues) 或官网 [反馈页面](https://dicad.cn/feedback) 提交问题。
Please report problems via [GitHub Issues](https://github.com/luoda2023/LDownload/issues) or the [feedback page](https://dicad.cn/feedback) on the official site.

## 文档贡献 / Documentation Contributions

LDownload 官网文档（<https://dicad.cn/docs/>）与源码同仓库维护，欢迎通过 Pull Request 贡献或翻译。
The LDownload documentation site (<https://dicad.cn/docs/>) is maintained in this repository — contributions and translations via Pull Request are welcome.
...
提交 PR 时可选择 "docs" 模板（`.github/PULL_REQUEST_TEMPLATE/docs.md`），源码仓库地址：<https://github.com/luoda2023/LDownload>。
When opening a PR you can pick the "docs" template (`.github/PULL_REQUEST_TEMPLATE/docs.md`). Source repository: <https://github.com/luoda2023/LDownload>.
