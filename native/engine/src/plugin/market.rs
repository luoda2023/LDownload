...
//! （CDN / R2 / 众包镜像）分发。**LDownload 用自己的引擎下载并本地验证插件**。
//!
//! ## v1 范围（记录在案的取舍）
...
pub const DEFAULT_INDEX_SOURCES: &[&str] = &[
    "https://raw.githubusercontent.com/luoda2023/ldownload-plugin-index/main/index.json",
    "https://cdn.jsdelivr.net/gh/luoda2023/ldownload-plugin-index@main/index.json",
];
