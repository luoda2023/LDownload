//! `ldown_engine` —— LDownload 下载引擎,零 FFI 依赖。
//!
...
///     app_data_dir: "/tmp/ldownload".to_string(),
...
/// LDownload 下载引擎 facade —— 零 FFI 依赖,是本 crate 的唯一公开入口。
///
/// 聚合 [`db::Db`](Db)(持久化)与
...
/// ```
/// # async fn run() {
/// use ldown_engine::NoopSelection;
