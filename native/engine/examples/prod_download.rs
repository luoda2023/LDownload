...
//! run: cargo run -p ldown_engine --example prod_download

use std::collections::HashMap;
use std::sync::{Arc, Mutex as StdMutex};
use std::time::Duration;

use ldown_engine::ed2k::client::{ClientConfig, Source, shared_client};
use ldown_engine::ed2k::hash::PART_SIZE;
use ldown_engine::ed2k::peer::download_block_from_peer;
...
async fn main() {
    ...
    let dest = std::env::temp_dir().join("ldownload_prod_probe.part");
