...
//!
//! 独立于 `ldown_engine::model` 定义：API 一经发布（`/api/v1`）即为对外稳定
...
impl From<RequestBody> for ldown_engine::downloader::CapturedRequestBody {
    ...
    /// use ldown_engine::downloader::CapturedRequestBody;
    ///
...
///
/// ```
/// use ldown_api::types::DownloadRequest;
///
...
///
/// ```
/// use ldown_api::types::TaskDto;
/// use ldown_engine::model::TaskInfo;
///
/// let info = TaskInfo {
...
impl From<ldown_engine::model::TaskInfo> for TaskDto {
    fn from(t: ldown_engine::model::TaskInfo) -> Self {
        Self {
            task_id: t.task_id,
            url: t.url,
...
///
/// ```
/// use ldown_api::types::QueueDto;
/// use ldown_engine::model::QueueInfo;
///
/// let q = QueueInfo {
...
impl From<ldown_engine::model::QueueInfo> for QueueDto {
    fn from(q: ldown_engine::model::QueueInfo) -> Self {
        Self {
            queue_id: q.queue_id,
            name: q.name,
...
///
/// ```
/// use ldown_api::types::CreateTaskRequest;
///
...
#[cfg(feature = "plugins")]
impl From<ldown_engine::plugin::SettingField> for SettingFieldDto {
    fn from(f: ldown_engine::plugin::SettingField) -> Self {
        use ldown_engine::plugin::{SettingType, SettingWidget};
...
#[cfg(feature = "plugins")]
impl From<ldown_engine::plugin::PluginInfo> for PluginDto {
    fn from(p: ldown_engine::plugin::PluginInfo) -> Self {
        Self {
            identity: p.identity,
            name: p.name,
            version: p.version,
...
#[cfg(feature = "plugins")]
impl From<ldown_engine::plugin::MarketEntry> for MarketEntryDto {
    fn from(e: ldown_engine::plugin::MarketEntry) -> Self {
        Self {
...
///
/// ```
/// use ldown_api::types::GroupDto;
/// use ldown_engine::model::GroupInfo;
///
/// let info = GroupInfo {
...
impl From<ldown_engine::model::GroupInfo> for GroupDto {
    fn from(g: ldown_engine::model::GroupInfo) -> Self {
        Self {
            group_id: g.group_id,
            name: g.name,
...
///
/// ```
/// use ldown_api::types::CreateGroupRequest;
///
...
///
/// ```
/// use ldown_api::types::ResolvePreviewRequest;
///
...
mod tests {
    ...
    fn create_task_request_deserializes_browser_transaction_fields() {
        ...
        .unwrap();
        match ldown_engine::downloader::CapturedRequestBody::from(form) {
            ldown_engine::downloader::CapturedRequestBody::FormData { fields } => {
...
///
/// 与引擎 `link::manager::PairConfirmOutcome` 一一对应，但独立定义：`ldown_api`
...
///
/// ```
/// use ldown_api::types::RssSourceDto;
///
...
impl From<ldown_engine::rss::model::RssSourceInfo> for RssSourceDto {
    fn from(s: ldown_engine::rss::model::RssSourceInfo) -> Self {
        Self {
...
impl From<RssSourceDto> for ldown_engine::rss::model::RssSourceInfo {
    fn from(s: RssSourceDto) -> Self {
        Self {
            ...
            interval_minutes: if s.interval_minutes > 0 {
                ...
                ldown_engine::rss::model::DEFAULT_INTERVAL_MINUTES
            },
            include_pattern: s.include_pattern,
            exclude_pattern: s.exclude_pattern,
            use_regex: s.use_regex,
            ...
            max_per_fetch: if s.max_per_fetch > 0 {
                ...
                ldown_engine::rss::model::DEFAULT_MAX_PER_FETCH
            },
            cookies: s.cookies,
            user_agent: s.user_agent,
            proxy_url: s.proxy_url,
...
impl From<ldown_engine::rss::model::RssItemInfo> for RssItemDto {
    fn from(i: ldown_engine::rss::model::RssItemInfo) -> Self {
        Self {
