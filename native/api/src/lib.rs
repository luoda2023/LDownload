//! `ldown_api` —— LDownload 本机 HTTP API：契约 + axum 服务器，零 FFI 依赖。
//!
...
//! use ldown_api::server::{ApiServerConfig, spawn_api_server};
//! use ldown_api::service::{ApiError, ApiHost};
//! use ldown_api::types::{CreateTaskRequest, DownloadRequest, QueueDto, TaskDto};
//!
//! struct MyHost;
//!
//! #[async_trait]
