//! Embed Windows PE version information into `ldown_updater.exe`.
//!
...
fn embed_version_info() {
    ...
    res.set("FileDescription", "LDownload Update Helper");
    res.set("InternalName", "ldown_updater");
    res.set("OriginalFilename", "ldown_updater.exe");
    res.set(
        "LegalCopyright",
    ...
    if let Err(e) = res.compile() {
        ...
        println!("cargo:warning=ldown_updater version resource failed: {e}");
    }
}
