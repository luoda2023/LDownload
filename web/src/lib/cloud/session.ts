...
const ACCESS_TOKEN_KEY = 'ldownload.cloud.accessToken'
const REFRESH_TOKEN_KEY = 'ldownload.cloud.refreshToken'
const USER_KEY = 'ldownload.cloud.user'
const DEVICE_ID_KEY = 'ldownload.cloud.deviceId'
