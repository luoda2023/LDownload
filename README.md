...
<img src="assets/logo/ldownload_logo.png" alt="LDownload Logo" width="128" />
...
[![Latest Release](https://img.shields.io/github/v/release/luoda2023/LDownload?style=flat-square&color=06b6d4&label=release)](https://github.com/luoda2023/LDownload/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/luoda2023/LDownload/total?style=flat-square&color=22c55e)](https://github.com/luoda2023/LDownload/releases)
...
[![Portainer](https://img.shields.io/badge/Portainer-Template-13BEF9?style=flat-square&logo=portainer&logoColor=white)](https://portainer-templates.as93.net/ldownload)
[![Unraid CA](https://img.shields.io/badge/Unraid-CA-F15A2C?style=flat-square)](https://github.com/selfhosters/unRAID-CA-templates/blob/master/templates/ldownload.xml)
...
[**Website**](https://dicad.cn) · [**Download**](https://dicad.cn/#download) · [**Changelog**](https://dicad.cn/changelog) · [**FAQ**](https://dicad.cn/faq) · [**Feedback**](https://dicad.cn/feedback)
...
Grab the latest build from [**GitHub Releases**](https://github.com/luoda2023/LDownload/releases/latest) or [**dicad.cn**](https://dicad.cn/#download):
...
| **NAS / Server** (headless, x64 / ARM64) | [Docker](https://ghcr.io/luoda2023/ldownload-server) · Synology DSM 6/7 `.spk` · QNAP `.qpkg` · OpenWrt `.ipk` · Unraid CA template · CasaOS / ZimaOS app store |

### Browser Extension

Install the extension so LDownload takes over browser downloads automatically:

[<img src="https://img.shields.io/badge/Chrome-Web%20Store-4285F4?style=for-the-badge&logo=googlechrome&logoColor=white" alt="Chrome Web Store" />](https://chromewebstore.google.com/detail/ldownload/meleenglfggcmcajknpeeeiobnpfmahc)
[<img src="https://img.shields.io/badge/Edge-Add--ons-0078D4?style=for-the-badge&logo=microsoftedge&logoColor=white" alt="Edge Add-ons" />](https://microsoftedge.microsoft.com/addons/detail/ldownload/nglkkjbogjghekbhhcnccnpfedjbdhhd)
[<img src="https://img.shields.io/badge/Firefox-Add--ons-FF7139?style=for-the-badge&logo=firefoxbrowser&logoColor=white" alt="Firefox Add-ons" />](https://addons.mozilla.org/firefox/addon/ldownload)

## MCP Server (Model Context Protocol)

LDownload ships a built-in **MCP server** so AI agents (Claude Desktop, Cursor, Cline, …) can manage downloads via the [Model Context Protocol](https://modelcontextprotocol.io). It speaks **Streamable HTTP** (JSON-RPC 2.0 over a single `POST /mcp`) on the local API port — no extra process needed.

- **Endpoint**: `http://127.0.0.1:17800/mcp` (local-only by default)
- **Auth**: Bearer token (`Authorization: Bearer <token>` or `X-LDownload-Token`), shared with the management API
...
| Browser extension | WXT + TypeScript | [`ldownload/`](ldownload) |
...
git clone -b main https://github.com/luoda2023/LDownload.git
cd LDownload
...
The NMH relay binary (`ldown_nmh`) is built automatically by CMake during `flutter build`. Distribution packages (AppImage / deb / Arch / portable) are produced by [CI](.github/workflows/release.yml) on every tag.
...
cargo test -p ldown_engine        # Rust engine tests
...
- **Bug reports / feature requests** — [GitHub Issues](https://github.com/luoda2023/LDownload/issues) or the in-app feedback dialog
- **QQ Group** — [832143651](https://dicad.cn/qq-group)
...
**If LDownload saves you time, consider giving it a Star — it helps more people discover the project.**

Made by [luoda2023](https://github.com/luoda2023)
