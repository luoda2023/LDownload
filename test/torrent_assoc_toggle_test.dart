...
/// Repro for luoda2023/LDownload#98: on Linux (.deb install) the
/// "Associate .torrent files" toggle cannot be turned off.
///
/// The .deb registers `com.ldownload.app.desktop` system-wide (root-owned),
/// so after `disassociate()` strips the per-user mimeapps.list override,
/// `xdg-mime query default application/x-bittorrent` STILL resolves LDownload.
