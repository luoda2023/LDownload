...
import 'package:ldownload/src/popup/popup_payload.dart';
import 'package:ldownload/src/services/popup_window_service.dart';
import 'package:ldownload/src/theme/theme_provider.dart';
...
void main() {
  ...
  const channel = MethodChannel('ldownload/popup_host');
