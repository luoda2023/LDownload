...
struct PopupPresentScaleTest {
    ...
    static func main() {
        ...
        guard let hostChannel = FlutterMethodChannel.registry["ldownload/popup_host"] else {
            print("FATAL: ldownload/popup_host not registered")
            exit(2)
        }
        ...
        guard let childChannel = FlutterMethodChannel.registry["ldownload/popup_child"] else {
            print("FATAL: ldownload/popup_child not registered")
            exit(2)
        }
