...
const en: Record<MessageKey, string> = {
  ...
  // Options page
  "options.title": "LDownload Settings",
  "options.remoteDesc":
    "Configure the ldown_server address and access token. Remote modes unlock after the connection test passes.",
  ...
  "notify.sentToLDownload": "{name} sent to LDownload",
  "notify.batchSentDetail": "{count} tasks sent to LDownload",
  "notify.sendFailed": "Send Failed",
  "notify.connectionFailed": "Cannot connect to LDownload app: {message}",
  "notify.fallbackBrowser": "Fell back to browser download",
  "notify.fallbackBrowserDetail":
    "Could not send to LDownload, fell back to browser: {url}",
  "notify.appUnavailable": "LDownload app not detected",
  "notify.appUnavailableDetail":
    "Temporarily using the browser's built-in download. Make sure the LDownload desktop app is running; interception will resume automatically.",
  ...
  // Context menu
  "contextMenu.sendToLDownload": "Download this link with LDownload",
  "contextMenu.sendImageToLDownload": "Download this image with LDownload",
  "contextMenu.sendVideoToLDownload": "Download this video/audio with LDownload",
  "contextMenu.sendPageToLDownload": "Download this page with LDownload",

  // Manifest
  "manifest.description":
    "Intercept browser downloads and send to LDownload app for high-speed downloading",
  ...
  "popup.tasks.appNotRunning": "LDownload is not running",
  "popup.tasks.startApp": "Start LDownload",
  ...
  "popup.quickDownload.sent": "Sent to LDownload",
  ...
  // Custom protocol (ldownload://)
  "options.protocol.label": "LDownload Protocol",
  "options.protocol.enabled": "On — launch app via ldownload://",
  "options.protocol.disabled": "Off (default)",
  "options.protocol.desc": "Launch the app via the ldownload:// protocol — supported on Windows, macOS, Linux and Android. The native channel is more capable, so enable this only when it is unavailable",
