...
const zhCN = {
  ...
  // Options page
  "options.title": "LDownload 设置",
  "options.remoteDesc":
    "配置 ldown_server 的地址与访问令牌，测试连接通过后即可在弹出窗中选择远程模式",
  ...
  "notify.sentToLDownload": "{name} 已发送到 LDownload",
  "notify.batchSentDetail": "{count} 个任务已发送到 LDownload",
  "notify.sendFailed": "发送失败",
  "notify.connectionFailed": "无法连接到 LDownload 应用: {message}",
  "notify.fallbackBrowser": "已回退到浏览器下载",
  "notify.fallbackBrowserDetail":
    "无法发送到 LDownload，已交由浏览器继续下载: {url}",
  "notify.appUnavailable": "未检测到 LDownload 应用",
  "notify.appUnavailableDetail":
    "已暂时改用浏览器自带下载。请确认 LDownload 桌面端已启动，稍后将自动恢复接管。",
  ...
  // Context menu
  "contextMenu.sendToLDownload": "使用 LDownload 下载此链接",
  "contextMenu.sendImageToLDownload": "使用 LDownload 下载此图片",
  "contextMenu.sendVideoToLDownload": "使用 LDownload 下载此视频/音频",
  "contextMenu.sendPageToLDownload": "使用 LDownload 下载此页面",

  // Manifest
  "manifest.description":
    "拦截浏览器下载，发送到 LDownload 桌面应用进行高速下载",
  ...
  "popup.tasks.appNotRunning": "LDownload 未运行",
  "popup.tasks.startApp": "启动 LDownload",
  ...
  "popup.quickDownload.sent": "已发送到 LDownload",
  ...
  // 自定义协议（ldownload://）
  "options.protocol.label": "LDownload 自定义协议",
  "options.protocol.enabled": "已启用，经 ldownload:// 唤起应用",
  "options.protocol.disabled": "关闭（默认）",
  "options.protocol.desc": "经 ldownload:// 协议唤起应用下载，Windows / macOS / Linux / Android 均支持。本机通道功能更全，建议仅在其不可用时开启",
